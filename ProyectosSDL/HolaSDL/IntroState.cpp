...
{
	if (done_) { app->getStateMachine()->popState(false); app->getStateMachine()->pushState(new TransitionScreen(app, prevState, 1000)); delete this; } //el delete this me duele ponerlo en verda
}
