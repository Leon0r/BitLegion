...
std::vector<std::string> Resources::imageFiles_ { "..//images/AlenaSpriteSheet.png",
	...
	"..//images//escena11caso1.png", "..//images//puertaTrasera_edificio_Drzewo.png", "..//images//Cubo de basura_edificio_Drzewo.png", "..//images//Basura_edificio_Drzewo.png", "..//images//escalera Incendios_edificio_Drzewo.png"  }; 
